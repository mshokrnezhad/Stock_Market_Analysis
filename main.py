...
number_of_training_features = 2 # 1 + number of days we want to use their price as the training features
...
X, real_Y = build_real_linear_data_set(0, price_list, number_of_data_sets, number_of_training_features)
